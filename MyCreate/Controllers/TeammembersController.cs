...
namespace MyCreate.Controllers
{
    public class TeammembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Jop,Image")] Teammember teammember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Jop,Image")] Teammember teammember)
        {
            if (id != teammember.Id)
            {
                return NotFound();
