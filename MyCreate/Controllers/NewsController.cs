...
namespace MyCreate.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create1(News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,Title,Date,Topic,categoeyId")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Date,Topic,categoeyId")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
